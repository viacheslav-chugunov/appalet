    ...
    fun showCleanUpAnimation(delay: Long = 200L) {
        viewModelScope.launch(coroutineContext) {
            ...
            while (model.input1.isNotBlank() || model.input2.isNotBlank()) {
                ...
                if (newInput1.isNotBlank()) newInput1 = newInput1.substring(0, model.input1.length - 1)
                if (newInput2.isNotBlank()) newInput2 = newInput2.substring(0, model.input2.length - 1)
